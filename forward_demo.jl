...
if demo == 1
    ...
    @time data, U = forward_acoustic(a, b, Nx, Ny, Nt, dx, dy, dt, source_num, source_position, source_vals, receiver_num, receiver_position, pml_len, pml_coef; blockx=16, blocky=16, idx_source=5, recordWaveField=true)
    println("    Done.")
